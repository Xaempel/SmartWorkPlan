...
namespace ShiftPlaceAlgorithms {

   /// @brief a method who place worker shifts based on single placed algorithm
   void singlePlaceShiftAlgorithms(ShiftWizard* shiftWizard, ShiftModel* shiftModel, QVector<CalendarFieldWidget*>* calendarFieldWidgets);

   /// @brief a method who place worker shifts based on automatic placed algorithm
   void autoPlaceShiftAlgorithms(ShiftModel* shiftModel, QVector<CalendarFieldWidget*>* calendarFieldWidgets);
}