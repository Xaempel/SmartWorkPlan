...
namespace InterFace {
   ...
   class IWorkerDataModel {
      public:
      virtual ~IWorkerDataModel() { }
      virtual bool saveWorkerLists(QString Name, QString SurName)   = 0;
      virtual QStringList loadWorkerLists()                         = 0;
      virtual void removeWorkerFromLists(int workerNumberToDeleted) = 0;
   };
